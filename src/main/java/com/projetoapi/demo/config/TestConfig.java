...
import com.projetoapi.demo.entities.Payment;
...
import com.projetoapi.demo.repositories.OrderItemRepository;
import com.projetoapi.demo.repositories.OrderRepository;
import com.projetoapi.demo.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		p1.getCetegories().add(cat2);		
		p2.getCetegories().add(cat1);		
		p2.getCetegories().add(cat3);		
		p3.getCetegories().add(cat3);		
		p4.getCetegories().add(cat3);		
		p5.getCetegories().add(cat2);
